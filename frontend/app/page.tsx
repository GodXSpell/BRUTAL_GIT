    ...
    <main className="flex-grow flex flex-col items-center w-full max-w-[1440px] mx-auto px-4 md:px-lg py-12 gap-xl">
      ...
      <section className="w-full flex flex-col items-start border-4 border-white p-lg md:p-xl relative bg-zinc-950 shadow-[8px_8px_0px_0px_#238636]">
        ...
        <div className="relative z-10 max-w-4xl">
          ...
          <p className="font-body-md text-body-md text-zinc-300 max-w-2xl mb-10 border-l-4 border-white pl-4">
            The unyielding platform for developers who build hard, ship fast,
            and don't compromise. No soft edges. No ambient blurs. Just pure,
            functional velocity.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            <button
              onClick={handleActionClick}
              className="bg-[#F0E050] text-black font-headline-lg text-[20px] font-bold uppercase px-8 py-4 border-2 border-black shadow-[4px_4px_0px_0px_#ffffff] hover:shadow-[2px_2px_0px_0px_#ffffff] hover:translate-x-[2px] hover:translate-y-[2px] transition-all active:shadow-none active:translate-x-[4px] active:translate-y-[4px] flex items-center justify-center gap-2"
            >
        ...
        <div className="absolute bottom-0 right-0 border-t-4 border-l-4 border-white bg-black p-4 hidden lg:flex flex-col items-end min-w-[200px]">
          <div className="text-zinc-500 font-label-sm text-label-sm uppercase mb-1">
            System Status
          </div>
      ...
      <section className="w-full mt-8 border-4 border-white bg-zinc-950 p-8 shadow-[8px_8px_0px_0px_#ffffff]">
        <div className="flex flex-col md:flex-row gap-8 items-center">
          <div className="flex-1">
            <h2 className="font-headline-xl text-[48px] text-[#238636] uppercase mb-4 leading-tight">
              Start Your
              <br />
              <span className="text-white">Open Source Journey</span>
            </h2>
            <p className="font-body-md text-zinc-300 mb-6 border-l-2 border-[#238636] pl-4">
              Frictionless onboarding with ephemeral environments. No setup
              required. Spin up a dev container, fix a bug, commit, and destroy.
            </p>
          ...
          <div className="flex-1 bg-black border-4 border-zinc-800 p-6 w-full font-mono text-sm text-[#7bdb80] overflow-x-auto">
            <pre>
              <code>
                $ brutal-cli env create --repo org/project &gt; Provisioning
                ephemeral container... &gt; Injecting secrets... &gt; Mounting
                workspace... [SUCCESS] Environment ready. $ code .
              </code>
            </pre>
          </div>
        </div>
      ...
      <section className="w-full mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
          ...
          <div className="border-4 border-white bg-black flex flex-col">
            ...
            <div className="flex flex-col p-4 gap-4">
              <div className="border-2 border-zinc-700 p-4 hover:border-[#238636] transition-colors cursor-pointer group">
                <div className="flex justify-between items-start mb-2">
                  <span className="text-[#238636] font-bold text-lg">
                    #1024
                  </span>
                  <span className="bg-[#238636]/20 text-[#238636] px-2 py-1 text-xs uppercase border border-[#238636]">
                    Help Wanted
                  </span>
                </div>
                <h4 className="text-white font-headline-lg text-[18px] group-hover:underline">
                  Fix race condition in rendering engine
                </h4>
            ...
            <button className="m-4 mt-auto border-2 border-white text-white p-3 hover:bg-white hover:text-black uppercase font-bold text-sm tracking-widest transition-none">
              View All Issues
            </button>
          </div>
          {/*  Commits Column  */}
          <div className="border-4 border-white bg-black flex flex-col">
            ...
            <div className="flex flex-col divide-y-2 divide-zinc-800">
              <div className="p-4 flex gap-4 hover:bg-zinc-900 transition-colors">
                <div className="w-12 h-12 bg-zinc-800 border-2 border-zinc-600 flex items-center justify-center font-bold text-zinc-400">
                  0xA1
                </div>
                <div>
                  <p className="text-white font-mono text-sm mb-1">
                    Merge pull request #42 from feature/brutal-ui
                  </p>
              ...
              <div className="p-4 flex gap-4 hover:bg-zinc-900 transition-colors">
                ...
                <div>
                  <p className="text-white font-mono text-sm mb-1">
                    refactor: remove soft gradients globally
                  </p>
                  <div className="flex gap-2 text-xs text-zinc-500 font-mono">
              ...
              <div className="p-4 flex gap-4 hover:bg-zinc-900 transition-colors">
                ...
                <div>
                  <p className="text-white font-mono text-sm mb-1">
                    fix: align grid to 4px baseline
                  </p>
                  <div className="flex gap-2 text-xs text-zinc-500 font-mono">
      ...
      <section className="w-full mt-8 border-4 border-[#238636] bg-black p-8 relative overflow-hidden">
        <div className="absolute right-0 top-0 opacity-10 pointer-events-none">
          <span
            className="material-symbols-outlined text-[400px] -translate-y-1/4 translate-x-1/4 text-[#238636]"
            data-icon="smart_toy"
          >
            smart_toy
          </span>
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <h2 className="font-headline-xl text-[48px] text-white uppercase mb-4 leading-tight">
            Agentic Flow
          </h2>
          <p className="font-body-md text-zinc-300 mb-8 border-l-4 border-[#238636] pl-4 text-lg">
            Self-Healing Pipelines keep you in the flow state. Our agents
            automatically analyze failures, suggest fixes, and test patches
            before you even see the red X.
          </p>
          <div className="flex items-center gap-4 border-2 border-zinc-700 p-4 bg-zinc-950 w-max">
            <span
              className="material-symbols-outlined text-[#238636] animate-spin"
              data-icon="sync"
            >
              sync
            </span>
            <span className="font-mono text-white text-sm">
              Pipeline #8892 Failed. Agent analyzing stack trace...
            </span>
          </div>
        </div>
      </section>
      ...
      <section className="w-full mt-8">
        <div className="flex items-center justify-between border-b-4 border-white pb-4 mb-8">
          <h2 className="font-headline-lg text-headline-lg text-white uppercase flex items-center gap-3">
            <span
              className="material-symbols-outlined text-[32px] text-[#F0E050]"
          ...
          <a
            className="text-[#238636] font-label-sm text-label-sm uppercase hover:underline flex items-center gap-1"
            href="#"
          >
            View all{" "}
            <span
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 w-full">
          ...
          <article className="md:col-span-8 border-4 border-white bg-zinc-950 p-6 flex flex-col shadow-[6px_6px_0px_0px_#ffffff] hover:shadow-[2px_2px_0px_0px_#ffffff] hover:translate-x-[4px] hover:translate-y-[4px] transition-all relative overflow-hidden group">
            ...
            <div className="absolute top-0 right-0 opacity-10 group-hover:opacity-20 transition-opacity pointer-events-none">
              <span
                className="material-symbols-outlined text-[240px] translate-x-1/4 -translate-y-1/4"
                data-icon="hub"
              >
                hub
              </span>
            ...
            <div className="flex items-start justify-between mb-4 relative z-10">
              <div className="flex items-center gap-3">
                <img
                  ...
                  data-alt="abstract black and white geometric pattern, high contrast, sharp lines, industrial feel"
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuAU2Nv-RNsWe5NV-9KBiS6y_9Mlj5jmuilM8Xj00kKtJydxy1jkSFuwMwygTju9xTDV8ONewboNyd_KiV-aB_8Uu9h0PHqjGdeN0V61BJZteUotaBpUZwW2uffIMoKlMo0S_Ek8Hxya_3uYG0gjFItTy1SBfaPTcviMfN_xwb2JK04lMgD0FnSG2U2Yme5NUOkFvzCj4l5WS3wYtTCextW_J7gOMh7DIlZLCqbiQARxthYV3Oc9uPUXAatAEayllLHBTlyXzBPzDCg"
                />
                <div>
                  <h3 className="font-headline-lg text-[24px] text-white hover:text-[#238636] cursor-pointer">
                    brutal-system / core-engine
                  </h3>
                  <div className="text-zinc-400 font-label-sm text-label-sm uppercase">
                    Updated 2 hours ago
                  </div>
                </div>
              </div>
            ...
            <p className="font-body-md text-body-md text-zinc-300 mb-6 flex-grow relative z-10 max-w-2xl border-l-2 border-[#238636] pl-3">
              The blazingly fast, unopinionated execution engine for brutalist
              web applications. Written in Rust. Designed for zero-compromise
              performance.
            </p>
            <div className="flex items-center gap-4 border-t-2 border-zinc-800 pt-4 relative z-10 flex-wrap">
              <div className="flex items-center gap-1 text-zinc-300 font-label-sm text-label-sm">
                <span className="w-3 h-3 bg-[#DEA584] rounded-none border border-black inline-block"></span>{" "}
                Rust
              </div>
          ...
          <article className="md:col-span-4 border-4 border-white bg-zinc-950 p-6 flex flex-col shadow-[6px_6px_0px_0px_#238636] hover:shadow-[2px_2px_0px_0px_#238636] hover:translate-x-[4px] hover:translate-y-[4px] transition-all">
            <div className="flex items-start justify-between mb-4">
              <div>
                <h3 className="font-headline-lg text-[20px] text-[#238636] hover:underline cursor-pointer break-words">
                  ui-components / raw-css
                </h3>
              </div>
            </div>
            <p className="font-body-md text-body-md text-zinc-400 mb-6 flex-grow">
              A utility-first CSS framework that completely removes
              border-radius, soft shadows, and gradients.
            </p>
            <div className="flex items-center gap-4 border-t-2 border-zinc-800 pt-4 flex-wrap">
              <div className="flex items-center gap-1 text-zinc-300 font-label-sm text-label-sm">
                <span className="w-3 h-3 bg-[#563D7C] rounded-none border border-black inline-block"></span>{" "}
                CSS
              </div>
              <div className="flex items-center gap-1 text-zinc-300 font-label-sm text-label-sm">
                <span
          ...
          <article className="md:col-span-6 border-4 border-white bg-[#010409] p-6 flex flex-col shadow-[6px_6px_0px_0px_#ffffff] hover:shadow-[2px_2px_0px_0px_#ffffff] hover:translate-x-[4px] hover:translate-y-[4px] transition-all">
            <div className="flex items-start justify-between mb-4">
              <div>
                <h3 className="font-headline-lg text-[20px] text-white hover:text-[#F0E050] cursor-pointer">
                  data-pipeline / terminal-viz
                </h3>
              </div>
              <div className="bg-[#F0E050] text-black font-label-sm text-[10px] uppercase px-2 py-1 font-bold border-2 border-black">
                New
              </div>
            </div>
            <p className="font-body-md text-body-md text-zinc-400 mb-6 flex-grow">
              Command-line data visualization tool. Renders charts strictly
              using ASCII characters in your terminal.
            </p>
            <div className="flex items-center justify-between border-t-2 border-zinc-800 pt-4">
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-1 text-zinc-300 font-label-sm text-label-sm">
                  <span className="w-3 h-3 bg-[#3572A5] rounded-none border border-black inline-block"></span>{" "}
                  Python
                </div>
                <div className="flex items-center gap-1 text-zinc-300 font-label-sm text-label-sm">
                  <span
          ...
          <article className="md:col-span-6 border-4 border-white bg-zinc-950 p-6 flex flex-col shadow-[6px_6px_0px_0px_#ffffff] hover:shadow-[2px_2px_0px_0px_#ffffff] hover:translate-x-[4px] hover:translate-y-[4px] transition-all border-dashed">
            <div className="flex items-center justify-center h-full min-h-[150px] flex-col gap-4">
              <span
                className="material-symbols-outlined text-[48px] text-zinc-500"
                data-icon="travel_explore"
              >
                travel_explore
              </span>
              <h3 className="font-headline-lg text-[20px] text-zinc-400 text-center">
                Discover more trending repositories across the network.
              </h3>
      ...
      <section className="w-full mt-8 border-4 border-white bg-black">
        <div className="border-b-4 border-white p-4 bg-zinc-900 flex justify-between items-center">
          ...
          <div className="hidden sm:flex border-2 border-white bg-black divide-x-2 divide-white">
            <button className="px-4 py-1 text-[#238636] font-label-sm text-label-sm uppercase bg-zinc-900">
              All
            </button>
            <button className="px-4 py-1 text-zinc-400 hover:text-white font-label-sm text-label-sm uppercase">
              C++
            </button>
            <button className="px-4 py-1 text-zinc-400 hover:text-white font-label-sm text-label-sm uppercase">
              Go
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-6 border-b-2 border-zinc-800 hover:bg-zinc-900 transition-colors gap-4">
            <div className="flex-grow">
              <div className="flex items-center gap-3 mb-2">
                <h3 className="font-headline-lg text-[20px] text-white cursor-pointer hover:underline">
                  facebook / react-brutal
                </h3>
                <span className="border border-zinc-600 px-2 py-0.5 text-zinc-400 font-label-sm text-[10px] uppercase rounded-none">
                  Public
                </span>
              </div>
              <p className="font-body-md text-body-md text-zinc-400 max-w-3xl">
                A declarative, efficient, and flexible JavaScript library for
                building unstyled user interfaces.
              </p>
            </div>
            <div className="flex items-center gap-6 min-w-max text-zinc-300 font-label-sm text-label-sm">
              <div className="flex items-center gap-1">
                <span className="w-3 h-3 bg-[#f1e05a] rounded-none border border-black inline-block"></span>{" "}
                JavaScript
              </div>
              <div className="flex items-center gap-1">
                <span
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-6 border-b-2 border-zinc-800 hover:bg-zinc-900 transition-colors gap-4">
            <div className="flex-grow">
              ...
              <p className="font-body-md text-body-md text-zinc-400 max-w-3xl">
                Linux kernel source tree with brutalist security configurations
                applied by default.
              </p>
            </div>
            <div className="flex items-center gap-6 min-w-max text-zinc-300 font-label-sm text-label-sm">
              <div className="flex items-center gap-1">
                <span className="w-3 h-3 bg-[#555555] rounded-none border border-black inline-block"></span>{" "}
                C
              </div>
              <div className="flex items-center gap-1">
                <span
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-6 hover:bg-zinc-900 transition-colors gap-4">
            <div className="flex-grow">
              ...
              <p className="font-body-md text-body-md text-zinc-400 max-w-3xl">
                The Go programming language. No garbage collection allowed
                variant.
              </p>
            </div>
            <div className="flex items-center gap-6 min-w-max text-zinc-300 font-label-sm text-label-sm">
              <div className="flex items-center gap-1">
                <span className="w-3 h-3 bg-[#00ADD8] rounded-none border border-black inline-block"></span>{" "}
                Go
              </div>
              <div className="flex items-center gap-1">
                <span
